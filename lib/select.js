...
var SelectComponent = function (_React$Component) {
  ...
  _createClass(SelectComponent, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      if (this.props.options && !_underscore2.default.isEqual(this.props.options, nextProps.options)) {
        this._setMenuItems(nextProps);
      }
    }
  }, {
    key: '_setMenuItems',
    value: function _setMenuItems(props) {
      this._options = this._getOptions(props);
      this._menuItems = this._options.map(function (item) {
    ...
    key: '_getOptions',
    value: function _getOptions(props) {
      if (props.options) {
        return props.options;
      } else if (props.fieldSchema.allowedValues) {
        return _underscore2.default.map(props.fieldSchema.allowedValues, function (allowedValue) {
          return {
            label: allowedValue,
            value: allowedValue
          };
